/** Estilos compartidos del CRM de leads (/panel): los mismos tonos que el
 *  panel de ventas, pero copiados aparte a propósito — son apps distintas
 *  dentro del mismo repo y el de ventas puede cambiar sin avisar. */
